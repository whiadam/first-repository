...
_deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-parse.dir/parse.cpp.o: _deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-parse.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --progress-dir=/workspaces/first-repository/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object _deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-parse.dir/parse.cpp.o"
	cd /workspaces/first-repository/build/_deps/yaml-cpp-build/util && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT _deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-parse.dir/parse.cpp.o -MF CMakeFiles/yaml-cpp-parse.dir/parse.cpp.o.d -o CMakeFiles/yaml-cpp-parse.dir/parse.cpp.o -c /workspaces/first-repository/build/_deps/yaml-cpp-src/util/parse.cpp
...
_deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-parse.dir/parse.cpp.i: cmake_force
	...
	cd /workspaces/first-repository/build/_deps/yaml-cpp-build/util && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /workspaces/first-repository/build/_deps/yaml-cpp-src/util/parse.cpp > CMakeFiles/yaml-cpp-parse.dir/parse.cpp.i
...
_deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-parse.dir/parse.cpp.s: cmake_force
	...
	cd /workspaces/first-repository/build/_deps/yaml-cpp-build/util && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /workspaces/first-repository/build/_deps/yaml-cpp-src/util/parse.cpp -o CMakeFiles/yaml-cpp-parse.dir/parse.cpp.s
...
_deps/yaml-cpp-build/util/parse: _deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-parse.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --bold --progress-dir=/workspaces/first-repository/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable parse"
	cd /workspaces/first-repository/build/_deps/yaml-cpp-build/util && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/yaml-cpp-parse.dir/link.txt --verbose=$(VERBOSE)
...
_deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-parse.dir/clean:
	cd /workspaces/first-repository/build/_deps/yaml-cpp-build/util && $(CMAKE_COMMAND) -P CMakeFiles/yaml-cpp-parse.dir/cmake_clean.cmake
...
_deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-parse.dir/depend:
	cd /workspaces/first-repository/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /workspaces/first-repository /workspaces/first-repository/build/_deps/yaml-cpp-src/util /workspaces/first-repository/build /workspaces/first-repository/build/_deps/yaml-cpp-build/util /workspaces/first-repository/build/_deps/yaml-cpp-build/util/CMakeFiles/yaml-cpp-parse.dir/DependInfo.cmake "--color=$(COLOR)"
